...
/**
 * Created by icastillo on 05/03/2018.
 */

public class Juego {

    private DatosGameActivity datosGameActivity;

    public Juego(){
        datosGameActivity=new DatosGameActivity();
    }

    public DatosGameActivity getDatosGameActivity() {
        return datosGameActivity;
    }

    public void setDatosGameActivity(DatosGameActivity datosGameActivity) {
        this.datosGameActivity = datosGameActivity;
    }
    ...
    private boolean sePuedeComprobarDiagonaIzquierdaDerecha(){
    ...
    * */
    ...
    private void compruebaDiagonaIzquierdaDerecha(){
        int aciertos=0;
        int columna=0;
        int fila=2;
        int iteraciones=2;
     ...
     * Postcondiciones:
     * */
    private boolean sePuedeComprobarDiagonaDerechaIzquierda(){
        boolean sePuede=true;
        int columna=datosGameActivity.getUltimaFichaPuesta()[0];
        int fila=datosGameActivity.getUltimaFichaPuesta()[1];
     ...
     * Postcondiciones:
     * */
    private void compruebaDiagonaDerechaIzquierda(){
        int aciertos=0;
        int columna=6;
        int fila=2;
        int iteraciones=2;
    ...
    private void comprobacionHorizontal(){
        ...
        for(int i=0;i<datosGameActivity.getArrayParaleloTablero().length-1 && !sal;i++){
            fichaActual=datosGameActivity.getArrayParaleloTablero()[i][fila];
