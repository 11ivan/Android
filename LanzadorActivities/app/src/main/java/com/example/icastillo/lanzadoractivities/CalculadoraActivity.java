...
public class CalculadoraActivity extends AppCompatActivity implements RadioGroup.OnCheckedChangeListener {
...
* */
    ...
    public void onCheckedChanged(RadioGroup rd, int idBtnRadio){
        Double n1 = null;
        Double n2 = null;
        if(!txtEdit1.getText().toString().replace(" ", "").equals("")) {
            n1 = Double.parseDouble(txtEdit1.getText().toString());
        }
        if(txtEdit2.getText().toString().replace(" ", "").equals("")) {
            n2 = Double.parseDouble(txtEdit2.getText().toString());
        }
